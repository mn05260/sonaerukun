...
_Generated: 2026-04-06T02:03:08.560Z_
...
Workspace `mcp.json` _(folder: sonaerukun)_

- **c:\Users\minto\Downloads\sonaerukun\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\minto\AppData\Roaming\Code\User\mcp.json** — _File missing_
